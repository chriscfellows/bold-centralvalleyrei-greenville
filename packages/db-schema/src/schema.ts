...
export const clients = pgTable("clients", {
  ...
  ownerLicense: varchar("owner_license", { length: 255 }),
  licenseState: varchar("license_state", { length: 100 }),
  disclosureAgency: text("disclosure_agency"),
  disclosureCashbuyer: text("disclosure_cashbuyer"),
  brokerageName: varchar("brokerage_name", { length: 255 }),
  brokerageLicense: varchar("brokerage_license", { length: 255 }),
