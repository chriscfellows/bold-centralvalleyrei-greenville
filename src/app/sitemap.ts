...
import { getWhySlug } from "@/config/site";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const whySlug = getWhySlug(siteConfig.siteName);
  return [
    { url: BASE_URL, lastModified: new Date(), changeFrequency: "weekly", priority: 1.0 },
    { url: BASE_URL + "/our-process", lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: BASE_URL + whySlug, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
